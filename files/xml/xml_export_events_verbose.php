...
do {
	...
	$xml->addAttribute('comments', "using this feed assumes that no other feeds are used. all tables (location, festival, stage, exhibition) are attached to each event (if relevant). not recommended for frequent updates.");
